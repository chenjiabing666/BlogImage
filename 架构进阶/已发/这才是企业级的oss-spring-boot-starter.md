...
![](D:\BlogImage\对象池\61.png)

### 七牛云对象存储兼容S3

![](D:\BlogImage\对象池\62.png)

### 腾讯云COS兼容S3

![](D:\BlogImage\对象池\63.png)

### Minio兼容S3

![](D:\BlogImage\对象池\64.png)
...
![](D:\BlogImage\对象池\65.png)

如下图所示，创建成功，让我们进入制作的过程吧。

![](D:\BlogImage\对象池\66.png)
...
![](D:\BlogImage\对象池\67.png)

这里我们选择第一个，点进去后我们选择1.12.423版本，做演示。

![](D:\BlogImage\对象池\68.png)
...
[docs.aws.amazon.com/AmazonS3/la…](https://link.juejin.cn/?target=https%3A%2F%2Fdocs.aws.amazon.com%2FAmazonS3%2Flatest%2FAPI%2FAPI_CreateBucket.html)
...
![](D:\BlogImage\对象池\72.png)

**执行install打包成jar到我们的本地仓库。**

![](D:\BlogImage\对象池\73.png)

到我们的本地仓库就能看到我们的oss-spring-boot-starter

![](D:\BlogImage\对象池\74.png)
...
![](D:\BlogImage\对象池\78.png)

到我的Minio中查看发现测试成功。

![](D:\BlogImage\对象池\79.png)
